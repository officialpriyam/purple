  ...
  return (
    <NodeButton
      className={classNames('group', {
        'bg-transparent text-purple-elements-item-contentDefault hover:text-purple-elements-item-contentActive hover:bg-purple-elements-item-backgroundActive':
          !selected,
        'bg-purple-elements-item-backgroundAccent text-purple-elements-item-contentAccent': selected,
      })}
      depth={depth}
...
function File({ file: { depth, name }, onClick, selected, unsavedChanges = false }: FileProps) {
  return (
    <NodeButton
      className={classNames('group', {
        'bg-transparent hover:bg-purple-elements-item-backgroundActive text-purple-elements-item-contentDefault': !selected,
        'bg-purple-elements-item-backgroundAccent text-purple-elements-item-contentAccent': selected,
      })}
      depth={depth}
      iconClasses={classNames('i-ph:file-duotone scale-98', {
        'group-hover:text-purple-elements-item-contentActive': !selected,
      })}
      onClick={onClick}
    >
      <div
